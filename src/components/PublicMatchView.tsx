...
// const PublicMatch: React.FC<PublicMatchProps> = ({ initialMatchId }) => {
...
//     const teamAPlayer = match.teamA.players?.find(p => p.id === playerId);
//     const teamBPlayer = match.teamB.players?.find(p => p.id === playerId);
//     return teamAPlayer?.name || teamBPlayer?.name || `Player ${playerId}`;
//   };
